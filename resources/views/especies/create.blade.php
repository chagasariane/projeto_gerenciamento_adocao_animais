        ...
        <div class="form-page-wrapper">
            ...
            <div class="form-page-header text-center d-flex flex-column align-items-center mb-5">
                ...
                <p class="crud-description form-page-description">
                    ...
                    Cadastre uma nova espécie para organizar corretamente
                    os animais disponíveis na plataforma de adoção responsável.
            ...
            <div class="form-section-card">
                ...
                <form action="{{ route('especies.store') }}"
                      method="POST">
                    ...
                    <div class="mb-0">
                        ...
                        <textarea
                            ...
                            rows="6"
                            placeholder="Descreva características gerais da espécie...">{{ old('descricao') }}</textarea>
